...
P3f=[qc[0][2], qc[1][2]]
P4f=[qc[0][3], qc[1][3]]
points = [[0.7583625, -0.7583624999999999],
 [0.5882625, -0.7938],
 [0.5599125, -0.37563749999999996],
 [0.7300125, -0.34019999999999995]]

D = Enviroment3d(s12,s13,s14,s23,s24,s34)
#E.AddPointsTest([P1f,P2f,P3f,P4f])
D.AddPointsTest(E.points)
D.Tmatrix(P1,P2,P3,P4)
result = D.GetPositonXYZ()
TT = D.T.T
o = np.array([[0],[0],[0],[1]])
